...
const Page = ({ selectedUniversity }) => {
  return (
    <>
      {selectedUniversity ? (
        <div>
          <h3>University Information</h3>
          <p>{`Selected University: ${selectedUniversity.name}`}</p>
          {selectedUniversity.name === 'Allahabad' && <Allahabad />}
          {selectedUniversity.name === 'Anna' && <Anna />}
          {selectedUniversity.name === 'Apj' && <Apj />}
          {selectedUniversity.name === 'Invertis' && <Invertis />}
          {selectedUniversity.name === 'Lucknow' && <Lucknow />}
